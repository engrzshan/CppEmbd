...
//	Step s_comp (Step::complete, &sev_seg);
	...
	Step s_empty(Step::empty,"empty");
	Step s_fill(Step::fill,"fill");
	Step s_heat(Step::heat,"heat");
	Step s_wash(Step::wash,"wash");
	Step s_rinse(Step::rinse,"rinse");
	Step s_spin(Step::spin,"spin");
	Step s_dry(Step::dry,"dry");
	Step s_comp(Step::complete,"complete");

	bind(s_empty, sev_seg);
	bind(s_fill, sev_seg);
	bind(s_heat, sev_seg);
	bind(s_wash, sev_seg);
	bind(s_rinse, sev_seg);
	bind(s_spin, sev_seg);
	bind(s_dry, sev_seg);
	bind(s_comp, sev_seg);
